...
No, the sample average of 𝜇̂ among only the tests where the null was
rejected is not approximately equal to the true value of μ, especially
when the true mean is small. When μ is close to 0, the test has low
...
As the true value of μ increases, the power of the test increases, and
almost all samples lead to rejection.When nearly all samples are
significant, the average of 𝜇̂ among rejected samples becomes much closer
to both the true μ and the overall sample average.
